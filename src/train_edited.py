        ...
        for offset in range(0, num_samples, batch_size):
            ...
            for fullpath in batch_samples:
                try:
                    ...
                    frame_number = basename.split("_")[0]

                    imageFullpath = os.path.join(os.path.dirname(fullpath), basename)
                    jsonFullpath =  os.path.join(os.path.dirname(fullpath), "record_" + frame_number + ".json")

                    # print("frame_number = " + frame_number)
                    # print("basename = " + basename)
                    # print("imageFullpath = " + imageFullpath)
                    # print("jsonFullpath = " + jsonFullpath)

                    # json_filename = os.path.join(os.path.dirname(fullpath), "record_" + frame_number + ".json")
                    data = load_json(jsonFullpath)
                    ...
                    try:
                        ...
                        print('failed to open', imageFullpath)
                        continue
                    ...
                    print(e)
                    print("we threw an exception on:", imageFullpath)
                    yield [], []
